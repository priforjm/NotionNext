const CONFIG = {
  ...
  SITE_CREATE_TIME: '2019-07-01', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '欢迎来到Jimmy的博客', url: 'https://huangjihao.com' },
    { title: "点击前往Jimmy Huang's Blog¹", url: 'https://jimmyhjh.com' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '记录生活',
  HERO_TITLE_2: '以及有的没的',
  HERO_TITLE_3: 'HUANGJIHAO.COM',
  HERO_TITLE_4: 'Notion Blog',
  HERO_TITLE_5: "Jimmy Huang's Blog¹",
  HERO_TITLE_LINK: 'https://jimmyhjh.com',
  ...
  INFO_CARD_URL: 'https://github.com/jimmyhuang22', // 个人资料底部按钮链接
  ...
  SOCIAL_CARD_TITLE_1: 'Contact Me',
  SOCIAL_CARD_TITLE_2: '',
  SOCIAL_CARD_TITLE_3: '点击查看联系方式',
  SOCIAL_CARD_URL: 'https://huangjihao.com/contact-me',
